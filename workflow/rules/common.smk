...
def check_config(config):
    ...
    if not ario_dir.exists() and ario_dir.isdir():
    ...
    if not script_dir.exists() and script_dir.isdir():
    ...
    if not source_data_dir.exists() and source_data_dir.isdir():
    ...
    if not config_dir.exists() and config_dir.isdir():
    ...
    if not builded_data_dir.exists() and builded_data_dir.isdir():
