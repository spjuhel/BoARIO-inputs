...
if __name__ == '__main__':
    ...
    if args.phase is None or args.phase == 1 :
        ...
        col2 = pd.Index(["final_cluster", "period","model","EXIO3_region","mrio", "sector type", "semester", "Total direct damage (2010€PPP)", "Population aff (2015 est.)", "dmg_as_direct_prodloss (M€)", "direct_prodloss_as_2015gva_share", "share of GVA used as ARIO input"])
